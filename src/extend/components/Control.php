...
/**
 * Базовый класс реализации визуального .NET компонента
 */
abstract class Control extends Component
{
     ...
     * 
     * [@param NetObject $parent = null] - родитель компонента
     * @param ...$args - аргументы создания компонента
     */
    ...
    # Алиасы различных .NET свойств и методов для упрощения использования
	...
	public function set_font ($font): void
	{
        ...
        else $this->setProperty ('Font', Additions::uncoupleSelector ($font));
    }
    ...
    public function set_bounds ($bounds): void
    {
        ...
        else $this->setProperty ('Bounds', Additions::uncoupleSelector ($bounds));
    }
    ...
    public function set_location ($location)
    {
        ...
        else $this->setProperty ('Location', Additions::uncoupleSelector ($location));
    }
    ...
    public function set_size ($size): void
    {
        ...
        else $this->setProperty ('Size', Additions::uncoupleSelector ($size));
    }
