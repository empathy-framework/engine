...
/**
 * Создание директории $path с параметрами $mode
 */
...
/**
 * Копирование содержимого дирректории $from в дирректорию $to
 */
...
/**
 * Преобразование HEX цвета в ARGB
 */
